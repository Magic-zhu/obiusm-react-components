(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  [0],
  {
    ...
    '3QDa': function (t, e, n) {
      ...
      function p(t, e, n, o) {
        return Object.entries(t[e]).reduce(function (t, e) {
          var i = r(e, 2),
            u = i[0],
            c = i[1];
          return (
            (t[u] = c.map(function (t) {
              var e = Object.assign({}, t);
              return (
                Object.keys(t).forEach(function (t) {
                  if (/^description(\.|$)/.test(t)) {
                    var r = t.match(/^description\.?(.*)$/),
                      i = a(r, 2),
                      u = i[1];
                    (u && u !== n) || (!u && !o)
                      ? delete e[t]
      ...
      var v = function (t) {
        var e = (0, o().useContext)(i['default']),
          ...
          r = e.config.locales,
          u = e.apis,
          c = !r.length || r[0].name === n,
          l = (0, o().useState)(p(u, t, n, c)),
          f = a(l, 2),
          s = f[0],
          d = f[1];
        return (
    ...
    beRK: function (t, e, n) {
      ...
      Object.defineProperty(e, '__esModule', { value: !0 }),
        (e.getDemoUrl = e.getDemoRouteName = e['default'] = void 0);
      var o = i(n('nLCz'));
      function i(t) {
        return t && t.__esModule ? t : { default: t };
      }
      ...
      var y = function (t) {
        ...
        return (
          (0, r().useEffect)(
            function () {
              l(t ? v(t, n.exportStatic && n.exportStatic.htmlSuffix) : null);
            },
            [t, n],
          ),
          c
