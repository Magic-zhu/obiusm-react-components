(function (e) {
  ...
  function i(e) {
    return (
      ...
      '' +
      ({
        0: 'vendors~Skeleton__index.md~Toast__index.md~docs__index.md~dumi_demos~wrappers',
        1: 'vendors~Skeleton__index.md~Toast__index.md~dumi_demos',
        3: 'Skeleton__index.md',
        4: 'Toast__index.md',
        5: 'docs__index.md',
        6: 'dumi_demos',
        8: 'vendors~wrappers',
    ...
    function D(e) {
      for (var t = O(_); null !== t; ) {
        if (null === t.callback) P(_);
          ...
          P(_), (t.sortIndex = t.expirationTime), T(I, t);
        }
        t = O(_);
      }
    }
      ...
      try {
        for (
          ...
          if (null !== u) {
            ...
            (n = t.unstable_now()),
              'function' === typeof l ? (A.callback = l) : A === O(I) && P(I),
              D(n);
          } else P(I);
          A = O(I);
        }
      ...
      (t.unstable_scheduleCallback = function (e, n, a) {
        ...
        return (
          ...
          l > u
            ? ((e.sortIndex = l),
              T(_, e),
              null === O(I) && e === O(_) && (L ? i() : (L = !0), o(U, l - u)))
            : ((e.sortIndex = a), T(I, e), N || M || ((N = !0), r(F))),
          e
        );
      }),
    ...
    var r,
      ...
      ie = function (e, t, n) {
        ...
        K
          ...
          (o = c['on' + e])
            ? o(r)
            : e === Y && P('Unhandled promise rejection', n);
      },
      ae = function (e, t) {
        S.call(c, function () {
          var n,
  ...
  '67WC': function (e, t, n) {
    ...
    if ((!P || !k || k === E) && ((k = x.prototype), P))
      for (r in I) a[r] && h(a[r].prototype, k);
    if ((P && d(w) !== k && h(w, k), i && !l(k, T)))
      for (r in ((R = !0),
      p(k, T, {
        get: function () {
          ...
          [
            ...
            function (e, o) {
              ...
              while (k < p.length) {
                ...
                if (
                  null === T ||
                  (S = h(c(b.lastIndex + (g ? 0 : k)), p.length)) === x
                )
                  k = l(p, k, y);
                else {
  ...
  FfOG: function (e, t, n) {
    ...
    var r = n('YS25'),
      o = { basename: '/obiusm-react-components/' };
  ...
  KKW8: function (e, t, n) {
    ...
    function M() {
      if (_) {
        var e = _,
          t = C;
        if (((C = _ = null), A(e), t)) for (e = 0; e < t.length; e++) A(t[e]);
      }
    }
    function N(e, t) {
      return e(t);
    ...
    function K(e) {
      return (
        !!H.call(q, e) ||
        (!H.call(G, e) && (V.test(e) ? (q[e] = !0) : ((G[e] = !0), !1)))
      );
    }
    function Y(e, t, n, r) {
    ...
    function Ft(e, t, n, r, o) {
      switch (t) {
        ...
        case 'pointerover':
          var i = o.pointerId;
          return _t.set(i, Ut(_t.get(i) || null, e, t, n, r, o)), !0;
        case 'gotpointercapture':
          return (
            (i = o.pointerId),
            Ct.set(i, Ut(Ct.get(i) || null, e, t, n, r, o)),
            !0
          );
      }
      return !1;
    ...
    var jr = !1;
    function Mr() {
      Rr && (Rr.detachEvent('onpropertychange', Nr), (Ir = Rr = null));
    }
    function Nr(e) {
      if ('value' === e.propertyName && Cr(Ir))
        if (((e = Pr(Ir, e, vt(e))), F)) ht(e);
        else {
          F = !0;
          try {
            N(_r, e);
    ...
    function Lr(e, t, n) {
      'focus' === e
        ? (Mr(), (Rr = t), (Ir = n), Rr.attachEvent('onpropertychange', Nr))
        : 'blur' === e && Mr();
    }
    function Dr(e) {
    ...
    function Lo(e, t, n) {
      if (_o.current !== Io) throw Error(a(168));
      Ro(_o, t), Ro(Co, n);
    }
    function Do(e, t, n) {
      var r = e.stateNode;
    ...
    function ci(e) {
      return null === ei ? ((ei = [e]), (ti = zo(qo, fi))) : ei.push(e), $o;
    }
    function si() {
      if (null !== ti) {
        var e = ti;
    ...
    function fi() {
      if (!ni && null !== ei) {
        ...
        try {
          ...
          throw (null !== ei && (ei = ei.slice(e + 1)), zo(qo, si), n);
        } finally {
          ni = !1;
        }
      }
    ...
    var Ci = ee.ReactCurrentBatchConfig,
    ...
    function Ui(e, t, n, r) {
      ...
      'object' === typeof i && null !== i
        ? (o.context = ki(i))
        : ((i = Mo(t) ? Ao : _o.current), (o.context = jo(e, i))),
        Ii(e, n, o, r),
    ...
    function Zi(e, t) {
      switch ((Ro(Yi, t), Ro(Ki, e), Ro(qi, Gi), (e = t.nodeType), e)) {
        case 9:
        case 11:
    ...
    var Ma = {
      ...
      Na = {
        ...
        useTransition: function (e) {
          var t = ma(!1),
            n = t[0];
          return (t = t[1]), [Ia(Aa.bind(null, t, e), [t, e]), n];
        },
      },
      La = {
        readContext: ki,
            ...
            if (((e = Qi(qi.current)), Ga(t))) {
              ...
              switch (((r[Un] = t), (r[Fn] = u), i)) {
                ...
                case 'details':
                  ...
                  break;
                case 'input':
                  Ie(r, u), nn('invalid', r), yn(n, 'onChange');
                  break;
                case 'select':
              ...
              switch (
                ...
                case 'details':
                  ...
                  break;
                case 'input':
                  Ie(e, r), (c = Re(e, r)), nn('invalid', e), yn(n, 'onChange');
                  break;
                case 'option':
                  c = Ne(e, r);
                  break;
    ...
    function gu(e) {
      switch (e.tag) {
        ...
        case 3:
          if (($i(), Po(Co), Po(_o), (t = e.effectTag), 0 !== (64 & t)))
            throw Error(a(285));
    ...
    function Rl(e, t) {
      if (((xl = 0), t)) return (t = kl()), hc(e, t), Pl(e), null;
      var n = Ol(e);
      if (0 !== n) {
    ...
    function Hl(e, t) {
      ...
      if (
        ...
        (tn = !!In), (_n = In = null), (e.current = n), (fl = o);
        do {
          try {
            for (w = e; null !== fl; ) {
              var E = fl.effectTag;
    ...
    Uu = function (e, t, n) {
      ...
      if (null !== e) {
        ...
        if (e.memoizedProps !== o || Co.current) Ya = !0;
        else {
          if (r < n) {
            switch (((Ya = !1), t.tag)) {
              case 3:
  ...
  Kz25: function (e, t, n) {
      ...
      (i &&
        l(Ie, {
          ...
          pathname: We(Ue, function (e) {
            var t = E(this);
            t.cannotBeABaseURL || ((t.path = []), Pe(t, e + '', ke));
          }),
    ...
    g(Re, 'URL'), o({ global: !0, forced: !a, sham: !i }, { URL: Re });
  },
  LKBx: function (e, t, n) {
    'use strict';
    var r = n('I+eb'),
  ...
  LtsZ: function (e, t, n) {
    ...
    var O = Object(l['createContext'])(null),
      P = [],
      R = [],
      I = !1;
    function _(e) {
    ...
    function j(e, t) {
      return Object(l['createElement'])(A(e), t);
    }
    function M(e, t) {
      var n = Object.assign(
          {
    ...
    (L.Map = D),
      (L.preloadAll = function () {
        return new Promise(function (e, t) {
          U(P).then(e, t);
        });
      }),
      (L.preloadReady = function () {
        var e =
          ...
          },
          {
            ...
            value: function (e) {
              ...
              switch (
                  ...
                  return a
                                ...
                                while (1)
                                  switch ((e.prev = e.next)) {
                                    ...
                                    case 19:
                                      r = e.sent;
                                    case 20:
                                      return e.abrupt('return', f(f({}, n), r));
                                    case 21:
                                    case 'end':
                                      return e.stop();
                                  }
                    ...
                    : u.reduce(function (e, n) {
                        return (
                          ...
                          'function' === typeof n ? n(e, i) : f(f({}, e), n)
                        );
                      }, r);
                case z.event:
                ...
                case z.compose:
                  return function () {
                    return V({ fns: u.concat(r), args: i })();
                  };
              }
            },
          },
    ...
    var x = b(function (e, t) {
      ...
      return a.a.createElement(r['h'].Consumer, null, function (e) {
        ...
        var n = x || e.location,
          ...
          _ = !!(g ? g(I, n) : I),
          C = _ ? w(h, u) : h,
          A = _ ? Object(l['a'])({}, S, {}, d) : S,
          j = Object(l['a'])(
            { 'aria-current': (_ && o) || null, className: C, style: A, to: i },
            P,
          );
        return (
          m !== b ? (j.ref = t || O) : (j.innerRef = O), a.a.createElement(y, j)
        );
      });
    });
  },
    ...
    r('replace', 2, function (e, t, n, r) {
      ...
      return [
        ...
        function (e, r) {
          ...
          for (var T = '', O = 0, P = 0; P < k.length; P++) {
            E = k[P];
            for (
              var R = String(E[0]),
                I = f(p(u(E.index), d.length), 0),
                _ = [],
                C = 1;
              C < E.length;
              C++
            ...
            var A = E.groups;
            if (h) {
              var j = [R].concat(_, I, d);
              void 0 !== A && j.push(A);
              var M = String(r.apply(void 0, j));
            } else M = w(R, d, I, _, A, r);
            I >= O && ((T += d.slice(O, I) + M), (O = I + R.length));
          }
          return T + d.slice(O);
        },
      ];
    ...
    var r = 2147483647,
      ...
      x = function (e) {
        ...
        while (k < l) {
          ...
          var S = k + 1;
          if (E - p > g((r - d) / S)) throw RangeError(h);
          for (d += (E - p) * S, p = E, n = 0; n < e.length; n++) {
            ...
            if (u == p) {
              for (var T = d, O = o; ; O += o) {
                ...
                var R = T - P,
                  I = o - P;
                t.push(y(b(P + (R % I)))), (T = g(R / I));
              }
              t.push(y(b(T))), (v = w(d, S, k == x)), (d = 0), ++k;
            }
          }
          ++d, ++p;
        }
  ...
  YS25: function (e, t, n) {
    ...
    function j(e) {
      ...
      function q(e) {
        (G += e),
          1 === G && 1 === e
            ? (window.addEventListener(_, R),
              o && window.addEventListener(C, j))
            : 0 === G &&
              (window.removeEventListener(_, R),
              o && window.removeEventListener(C, j));
      }
      var K = !1;
      function Y(e) {
        void 0 === e && (e = !1);
      ...
      function Y(e) {
        (K += e),
          1 === K && 1 === e
            ...
            : 0 === K && window.removeEventListener(M, P);
      }
      var Q = !1;
      function Z(e) {
        void 0 === e && (e = !1);
  ...
  Yhre: function (e, t, n) {
    ...
    if (i) {
      if (
        ...
        I = function (e) {
          return c(this, I), new R(p(e));
        };
        for (var G, q = (I[T] = R[T]), K = g(R), Y = 0; K.length > Y; )
          (G = K[Y++]) in I || a(I, G, R[G]);
        q.constructor = I;
      }
      v && h(C) !== A && v(C, A);
      var Q = new _(new I(2)),
    ...
    b(I, E), b(_, S), (e.exports = { ArrayBuffer: I, DataView: _ });
  },
  Z4nd: function (e, t, n) {
    'use strict';
    var r = n('I+eb'),
  ...
  fdAy: function (e, t, n) {
    ...
    e.exports = function (e, t, n, s, d, x, k) {
      ...
      var E,
        ...
        R = !1,
        I = e.prototype,
        _ = I[g] || I['@@iterator'] || (d && I[d]),
        C = (!v && _) || O(d),
        A = ('Array' == t && I.entries) || _;
      if (
        (A &&
          ((E = i(A.call(new e()))),
          h !== Object.prototype &&
            ...
            (f ||
              i(E) === h ||
              (a ? a(E, h) : 'function' != typeof E[g] && l(E, g, w)),
            u(E, P, !0, !0),
            f && (p[P] = w))),
        d == m &&
          _ &&
        ...
        if (((S = { values: O(m), keys: x ? C : O(y), entries: O(b) }), k))
          for (T in S) (v || R || !(T in I)) && c(I, T, S[T]);
  ...
  pNMO: function (e, t, n) {
    ...
    q[z][W] || P(q[z], W, q[z].valueOf), L(q, B), (C[F] = !0);
  },
  pevA: function (e, t, n) {
    'use strict';
    var r = n('I+eb'),
  ...
  rlch: function (e, t, n) {
    ...
    var E = Object(i['createContext'])(null),
      S = [],
      T = [],
      O = !1;
    function P(e) {
    ...
    function C(e, t) {
      ...
      if (
        ...
        !O && 'undefined' !== typeof window && 'function' === typeof n.webpack)
      ) {
        var u = n.webpack();
        T.push(function (e) {
          var t,
  ...
  tB8F: function (e, t, n) {
    ...
    function d(e, t, n) {
      return (
        ...
        e.some(function (e) {
          ...
          return (
            r &&
              (n.push({ route: e, match: r }), e.routes && d(e.routes, t, n)),
            r
          );
        }),
        n
    ...
    function I(e) {
      return f.a.createElement(l['h'].Consumer, null, function (t) {
    ...
    function C(e) {
      return f.a.createElement(l['h'].Consumer, null, function (t) {
        var n,
          ...
          a = null;
        return (
          s['Children'].forEach(r, function (e) {
            if (null === a && Object(s['isValidElement'])(e)) {
              n = e;
              var r = e.props.path || e.props.from;
              a = r
                ? Object(l['i'])(i.pathname, v(v({}, e.props), {}, { path: r }))
                : t.match;
            }
          }),
          a
    ...
    function j(e, t) {
      ...
      var n = x(e, A),
        r = e.component;
      function o(o) {
        var i = Object(s['useState'])(function () {
    ...
    function M(e) {
      ...
      if (i) {
        var u = n.isServer ? {} : window.g_initialProps,
          l = v(
            v(v(v({}, r), n.extraProps), n.pageInitialProps || u),
            {},
            { route: t, routes: n.rootRoutes },
          ),
          c = f.a.createElement(i, l, o);
        if (a) {
          var p = a.length - 1;
          while (p >= 0) (c = Object(s['createElement'])(a[p], l, c)), (p -= 1);
        }
        return c;
      }
      return o;
    ...
    function N(e) {
      ...
      return o.redirect
        ? f.a.createElement(l['c'], b({}, u, { from: o.path, to: o.redirect }))
        : (!a.ssrProps ||
            a.isServer ||
          ...
          f.a.createElement(
            ...
            b({}, u, {
              render: function (e) {
                return M({ route: o, opts: a, props: e });
              },
            }),
          ));
    }
    ...
    function U(e) {
      ...
      return (
        ...
        f.a.createElement(l['e'], { history: t }, L(n))
      );
    }
    function F(e) {
    ...
    function z(e) {
      var t = e.plugin.applyPlugins({
        type: c['ApplyPluginsType'].modify,
        key: 'rootContainer',
        initialValue: f.a.createElement(U, {
          history: e.history,
          routes: e.routes,
          plugin: e.plugin,
          ssrProps: e.ssrProps,
      ...
      window.g_useSSR
        ? e.dynamicImport
          ? F(e.routes).then(function () {
              Object(p['hydrate'])(t, n, r);
            })
          : Object(p['hydrate'])(t, n, r)
        : Object(p['render'])(t, n, r);
    }
    var W = n('9og8');
    function V() {
      var e = [
        {
          ...
          wrappers: [
            Object(i['c'])({
              loader: () =>
                Promise.all([n.e(0), n.e(8), n.e(9)]).then(
                  n.bind(null, 'Xmus'),
                ),
            }),
          ],
                        ...
                        while (1)
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (
                                (e.next = 2),
                                Promise.all([n.e(0), n.e(1), n.e(6)]).then(
                                ...
                                e.abrupt('return', (e) => {
                                  ...
                                  switch ((l(), o.length)) {
                                    case 1:
                                      return o[0];
                                    case 2:
                                      return f.a.createElement(i, o[0], o[1]);
                                    default:
                                      return 'Demo '.concat(
                                        e.match.params.uuid,
                                        ' not found :(',
          ...
          routes: [
            {
              ...
              meta: {
                ...
                title: 'Skeleton',
                group: { path: '/components/skeleton', title: 'Skeleton' },
              },
              title: 'Skeleton - obiusm-react-components',
            },
            {
              ...
              meta: {
                ...
                title: 'Toast',
                group: { path: '/components/toast', title: 'Toast' },
              },
              title: 'Toast - obiusm-react-components',
            },
            {
              path: '/',
              component: Object(i['c'])({
              ...
              meta: {
                ...
                footer:
                  '<div class="markdown"><p>Open-source MIT Licensed | Copyright \xa9 2020<br /></p></div>',
                slugs: [
                  {
                    depth: 2,
                    value: 'Hello obiusm-react-components!',
                    heading: 'hello-obiusm-react-components',
                  },
                ],
                title: 'Hello obiusm-react-components!',
              },
              title: 'Hello obiusm-react-components! - obiusm-react-components',
            },
            {
              path: '/components',
              meta: {},
              exact: !0,
              redirect: '/components/skeleton',
            },
          ],
          ...
          initialValue: () => {
            var t = r['a'].applyPlugins({
              ...
              initialValue: {
                ...
                dynamicImport: !0,
                rootElement: 'root',
                defaultTitle: 'obiusm-react-components',
              },
            });
            return z(t);
          },
  ...
  viRO: function (e, t, n) {
    ...
    function _(e, t, n, r, a) {
      ...
      if (((l = 0), (r = '' === r ? '.' : r + ':'), Array.isArray(e)))
        ...
        for (e = s.call(e), c = 0; !(u = e.next()).done; )
          (u = u.value), (s = r + I(u, c++)), (l += _(u, t, n, s, a));
      else if ('object' === u)
        throw (
          ((t = '' + e),
          Error(
    ...
    (t.Children = {
      ...
      (t.isValidElement = O),
      (t.lazy = function (e) {
        return { $$typeof: s, _payload: { _status: -1, _result: e }, _init: A };
      }),
      (t.memo = function (e, t) {
