    ...
    '0Bia': function (e, t, n) {
      ...
      var a = n('q1tI'),
        ...
        c =
          ...
          function (e) {
            var t = e.location,
              n = Object(a['useContext'])(l['context']),
              c = n.base,
              i = n.locale,
              u = n.config.locales,
              s = u.find(function (e) {
            ...
            function m(e) {
              ...
              if (e !== u[0].name) {
                var r = ''.concat(n, '/').concat(e).replace(/\/\//, '/'),
                  l = t.pathname.replace(c.replace(/^\/$/, '//'), '');
                return ''.concat(r).concat(l).replace(/\/$/, '');
              }
              return a;
            }
            return s
                  ...
                  u.length > 2
                    ? r.a.createElement(
                        'select',
                        {
                          value: i,
                          onChange: function (e) {
                            return o['a'].push(m(e.target.value));
                          },
                        },
                        u.map(function (e) {
                    ...
                    : r.a.createElement(l['Link'], { to: m(s.name) }, s.label),
                )
              : null;
          }),
        i = c,
        u =
          ...
          function (e) {
            var t = e.onMobileMenuClick,
              ...
              o = e.location,
              c = e.darkPrefix,
              u = Object(a['useContext'])(l['context']),
              s = u.base,
              m = u.config,
              f = m.mode,
              d = m.title,
            ...
            return r.a.createElement(
              ...
              r.a.createElement(
                ...
                r.a.createElement(
                  ...
                  r.a.createElement(i, { location: o }),
                  c,
                ),
              ),
            );
        ...
        y =
          ...
          function (e) {
            var t = e.mobileMenuCollapsed,
              n = e.location,
              o = e.darkPrefix,
              c = Object(a['useContext'])(l['context']),
              u = c.config,
              s = u.logo,
              m = u.title,
              f = u.description,
                    ...
                    h.map(function (e) {
                      var t,
                        ...
                        i = o
                          ...
                          : [
                              e.path,
                              n.pathname.startsWith(''.concat(e.path, '/')) &&
                              b.title === e.title
                                ? n.pathname
                                : null,
                            ];
                              ...
                              return r.a.createElement(
                                ...
                                Boolean(
                                  'menu' === b.toc &&
                                    ...
                                    e.path === n.pathname &&
                                    a,
                                ) && r.a.createElement(v, { slugs: b.slugs }),
                              );
                            }),
                          ),
                        c && r.a.createElement(v, { slugs: b.slugs }),
                      );
                    }),
                ),
              ),
        ...
        if (null != n) {
          ...
          try {
            for (n = n.call(e); !(o = (a = n.next()).done); o = !0)
              if ((l.push(a.value), t && l.length === t)) break;
          } catch (i) {
            (c = !0), (r = i);
          } finally {
            try {
            ...
            r.a.createElement(
              'div',
              {
                className: '__dumi-default-dark-switch '.concat(
                  !a && t ? '__dumi-default-dark-switch-open' : '',
                ),
              },
              a
                ? o.map(function (e) {
      ...
      var K = function (e) {
        ...
        J = function (e) {
          var t,
            ...
            N = M && d.hero,
            L = M && d.features,
            P = !1 !== d.sidemenu && !N && !L && !d.gapless,
            C =
              !N &&
              !L &&
              Boolean(
                null === (t = d.slugs) || void 0 === t ? void 0 : t.length,
              ) &&
              ('content' === d.toc || void 0 === d.toc) &&
              !d.gapless,
            z = /^zh|cn$/i.test(p),
            B = new Date(d.updatedTime),
            D = ''
              .concat(B.toLocaleDateString([], { hour12: !1 }), ' ')
              .concat(B.toLocaleTimeString([], { hour12: !1 })),
            H =
          ...
          return r.a.createElement(
            ...
            r.a.createElement(s, {
              location: c,
              navPrefix: r.a.createElement(A, null),
              darkPrefix: r.a.createElement(I, {
                darkSwitch: j,
              ...
              return (
                (null ===
                  (t = a[0].find(function (e) {
                    return new RegExp('/'.concat(e.name, '(/|$)')).test(a[1]);
                  })) || void 0 === t
                  ? void 0
                  : t.name) || e[0].name
              );
        ...
        E = function (e, t, n) {
          var a = function () {
              for (
                ...
                n[a] = arguments[a];
              for (
                var r = n[0].navs[n[1]] || [], l = '*', o = r.length - 1;
                o >= 0;
                o -= 1
              ) {
                var c = r[o],
